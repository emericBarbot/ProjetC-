...
namespace TransConnect
{
    class Program
    {
        ...
        // Création d'une interface utilisateur permettant l'affichage du graphe des villes et des arêtes
        static void InterfaceUtilisateur(Graphe graphe)
        {
            Console.WriteLine("Bienvenue dans l'interface de gestion des villes");
            Console.WriteLine("1 - Afficher le graphe");
            Console.WriteLine("2 - Calculer le plus court chemin");
            Console.WriteLine("3 - Calculer le plus rapide chemin");
            Console.WriteLine("4 - Quitter");
            ...
            switch (choix)
            {
                ...
                case "2":
                    ...
                    Ville villeDepart = graphe.Villes.Find(v => v.Nom.ToLower() == depart.ToLower());
                    Ville villeArrivee = graphe.Villes.Find(v => v.Nom.ToLower() == arrivee.ToLower());
                    PlusCourtChemin(graphe, villeDepart, villeArrivee);
                    break;
                case "3":
                    Console.WriteLine("Ville de départ : ");
                    ...
                    villeDepart = graphe.Villes.Find(v => v.Nom.ToLower() == depart.ToLower());
                    villeArrivee = graphe.Villes.Find(v => v.Nom.ToLower() == arrivee.ToLower());
                    PlusRapideChemin(graphe, villeDepart, villeArrivee);
                    break;
                case "4":
                    return;
            }
            InterfaceUtilisateur(graphe);
        }
    }
}